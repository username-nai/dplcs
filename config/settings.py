...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-h-+$w**q%er=(y$+$!@@gyzf&h91uijd6x7^ui+)*ix%d#gkb-')
...
if env('SUPABASE_DB_NAME', default=''):
    DATABASES = {
        'default': {
            ...
            'HOST': env('SUPABASE_DB_HOST', default=''),
...
AUTHENTICATION_BACKENDS = [
    'accounts.backends.MemberIDBackend',
